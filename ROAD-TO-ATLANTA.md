...
| Mon 21 or Tue 22 September | Session 3 | Your work in your own private copy of this folder, everything connected, and your Brain proved to be read by Claude |
...
1. **Check the plugin is current.** If you installed it at Session 3, it already has the step that writes your snapshot's words. If you installed it earlier, update it: it is not automatic, and [UPDATE-YOUR-SETUP.md](UPDATE-YOUR-SETUP.md) is how.
