...
# Apollo send_now, messages_create and campaigns_approve start sending: the
# founder presses start in Apollo themselves, having read it.
# Apollo email_account_purchase_create spends their money.
#
# Only in a Launchhouse folder. Everywhere else the founder's tools are theirs.
